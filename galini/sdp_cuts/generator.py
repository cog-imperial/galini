...
class SdpCutsGenerator(CutsGenerator):
    ...
    def __init__(self, config):
        ...
        # Problem info related to SDP cuts associated with every node of BabAlgorithm
        self.__problem_info_sdp = None
    ...
    def before_start_at_node(self, problem):
        ...
        self._agg_list_rescaled = self._rescale_for_selection()
        self._cut_round = 0
    ...
    def _generate(self, problem, linear_problem, solution, tree, node):
        ...
        for ix in range(0, sel_size):
            ...
            dim_act = len(x_vals)
            eigvals, evecs = get_eigendecomp(dim_act, x_vals, X_slice, True)
    ...
    def _get_sdp_selection(self, problem, solution):
        ...
        isNNused = self._cut_sel in ['OPT', 'COMB_ONE_CON', 'COMB_ALL_CON']
